...
#include "CharStackEx4.h"			// CharStack 클래스를 사용하기 위한 해더파일 포함
using namespace std;			// 명칭공간 std 사용

bool CharStackEx4::push(char ch)	// 스택에 데이터 삽입을 위한 push 함수의 정의
{
...
char CharStackEx4::pop()			// 스택에서 데이터를 꺼내올 pop함수의 정의
{
